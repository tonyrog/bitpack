...
static int inline set_bits_le(uint8_t* ptr, uint32_t value, int i, size_t n)
    ALWAYS_INLINE;
static int inline get_bits_le(const uint8_t* ptr, uint32_t* value, int i, size_t n)
    ALWAYS_INLINE;
static int inline get_bit_le2(const uint8_t* ptr, int k, int i)
    ALWAYS_INLINE;
static int inline get_bit_le(const uint8_t* ptr, int i)
    ALWAYS_INLINE;
...
static int inline copy_bits_le(uint8_t* src,uint32_t soffs,
 ...
 static int inline set_bits_be(uint8_t* ptr, uint32_t value, int i, size_t n)
     ALWAYS_INLINE;
 static int inline get_bits_be(const uint8_t* ptr, uint32_t* value, int i, size_t n)
     ALWAYS_INLINE;
static int inline get_bit_be2(const uint8_t* ptr, int k, int i)
    ALWAYS_INLINE;
static int inline get_bit_be(const uint8_t* ptr, int i)
    ALWAYS_INLINE;
...
static void inline set_bit_le(uint8_t* ptr, int val, int i)
{
    int k = i >> 3;     // byte position
    uint8_t src;
    i = BIT_OFFSET(i);
    src = val<<i;
    ptr[k] = MASK_BITS(src, ptr[k], L_MASK(i));
}
...
static int inline get_bit_le2(const uint8_t* ptr, int k, int i)
{
    return (ptr[k] & L_MASK(i)) != 0;
}

 
static int inline get_bit_le(const uint8_t* ptr, int i)
{
    return get_bit_le2(ptr, i>>3, BIT_OFFSET(i));    
}
...
static void inline set_bit_be(uint8_t* ptr, int val, int i)
{
    int k = i >> 3;     // byte position
    uint8_t src;
    i = BIT_OFFSET(i);
...
static int inline get_bit_be(const uint8_t* ptr, int i)
{
    return get_bit_be2(ptr, i>>3, BIT_OFFSET(i));
}
